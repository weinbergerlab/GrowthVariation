...
curve.cuts<-list(c(0,1),c(1.0,2.0),c(2.0 ,max(ratio_min_max_rate)))
par(mfrow=c(length(curve.cuts),3),mar=c(1,1,1,1))
...
matplot(t(fitted.all[increase.indices,]), type='l', lty=1, bty='l')
title(paste0("Smooth Observed ",i))
matplot(t(derivs.all[increase.indices,]), type='l', lty=1, bty='l')
abline(h=0, col='red')
title("1st Derivative")
matplot(t(derivs2.all[increase.indices,]), type='l', lty=1, bty='l')
abline(h=0, col='red')
